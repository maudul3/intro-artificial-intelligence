...
class Node:
    ...
    def __init__(self, state, parent=None, depth=0) -> None:
        """Constructor
...
def best_first(
    root, goal: list[str], heuristic_function, search_type: str, terminate_at=1000
):
            ...
            for heuristic in heuristics:
                print(
                    "Steps in {} via {} search and {} heuristic: ".format(
                        " ".join(ri.state), search, heuristic.__name__
                    )
                )
                print(best_first(ri, g, heuristic, search, terminate_at=100000))
